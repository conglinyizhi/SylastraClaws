...
The `SubTurn` mechanism is a core feature in SylastraClaws that allows tools to spawn isolated, nested agent loops to handle complex sub-tasks.
...
SubTurns emit specific events to the SylastraClaws `EventBus` for observability and debugging:
