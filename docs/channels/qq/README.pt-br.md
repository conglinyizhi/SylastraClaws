...
O SylastraClaws oferece suporte ao QQ via API Bot oficial da Plataforma Aberta QQ.
...
3. Preencha as credenciais no arquivo de configuração do SylastraClaws
4. Execute `sylastraclaws gateway` para iniciar o serviço
...
4. Preencha as credenciais no arquivo de configuração do SylastraClaws
5. Execute `sylastraclaws gateway` para iniciar o serviço
