...
SylastraClaws prend en charge QQ via l'API Bot officielle de la plateforme ouverte QQ.
...
3. Renseigner les identifiants dans le fichier de configuration SylastraClaws
4. Exécuter `sylastraclaws gateway` pour démarrer le service
...
4. Renseigner les identifiants dans le fichier de configuration SylastraClaws
5. Exécuter `sylastraclaws gateway` pour démarrer le service
