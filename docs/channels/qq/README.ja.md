...
SylastraClaws は QQ オープンプラットフォームの公式 Bot API を通じて QQ をサポートします。
...
3. SylastraClaws 設定ファイルに認証情報を入力する
4. `sylastraclaws gateway` を実行してサービスを起動する
...
4. SylastraClaws 設定ファイルに認証情報を入力する
5. `sylastraclaws gateway` を実行してサービスを起動する
