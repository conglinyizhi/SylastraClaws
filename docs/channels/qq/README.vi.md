...
SylastraClaws hỗ trợ QQ thông qua API Bot chính thức của Nền tảng Mở QQ.
...
3. Điền thông tin xác thực vào file cấu hình SylastraClaws
4. Chạy `sylastraclaws gateway` để khởi động dịch vụ
...
4. Điền thông tin xác thực vào file cấu hình SylastraClaws
5. Chạy `sylastraclaws gateway` để khởi động dịch vụ
