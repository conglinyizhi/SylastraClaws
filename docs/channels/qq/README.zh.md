...
SylastraClaws 通过 QQ 开放平台的官方机器人 API 提供对 QQ 的支持。
...
3. 将凭证填入 SylastraClaws 配置文件
4. 运行 `sylastraclaws gateway` 启动服务
5. 打开 QQ，与机器人开始对话
...
4. 将凭证填入 SylastraClaws 配置文件
5. 运行 `sylastraclaws gateway` 启动服务
