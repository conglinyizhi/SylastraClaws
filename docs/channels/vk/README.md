...
2. Store the actual token using one of these methods:
   - **Environment variable**: Set `SYLASTRACLAWS_CHANNELS_VK_TOKEN` environment variable
   - **Secure storage**: Use SylastraClaws's secure token storage mechanism

Example using environment variable:
```bash
export SYLASTRACLAWS_CHANNELS_VK_TOKEN="vk1.a.abc123..."
```
...
### 4. Configure SylastraClaws

1. Add the token to your SylastraClaws configuration
...
VK has a maximum message length of 4000 characters. SylastraClaws automatically splits longer messages into multiple parts.
...
4. Check SylastraClaws logs for error messages
