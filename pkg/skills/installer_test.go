...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repo:         "https://github.com/conglinyizhi/SylastraClaws/tree/dev/skills/test",
			wantOwner:    "conglinyizhi",
			wantRepoName: "SylastraClaws",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			name:         "full URL with blob",
			repo:         "https://github.com/conglinyizhi/SylastraClaws/blob/main/README.md",
			wantOwner:    "conglinyizhi",
			wantRepoName: "SylastraClaws",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/conglinyizhi/SylastraClaws",
			wantOwner:    "conglinyizhi",
			wantRepoName: "SylastraClaws",
			wantRef:      "main",
			wantSubPath:  "",
