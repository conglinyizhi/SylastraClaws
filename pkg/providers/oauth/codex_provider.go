...
import (
	...
	orc "github.com/conglinyizhi/SylastraClaws/pkg/providers/openai_responses_common"
)
...
func CreateCodexTokenSource() func() (string, string, error) {
	return func() (string, string, error) {
		...
		if cred == nil {
			return "", "", fmt.Errorf("no credentials for openai. Run: sylastraclaws auth login --provider openai")
		}
