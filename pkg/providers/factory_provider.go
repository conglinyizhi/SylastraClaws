...
import (
	...
	anthropicmessages "github.com/conglinyizhi/SylastraClaws/pkg/providers/anthropic_messages"
	"github.com/conglinyizhi/SylastraClaws/pkg/providers/azure"
	"github.com/conglinyizhi/SylastraClaws/pkg/providers/bedrock"
)
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: sylastraclaws auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: sylastraclaws auth login --provider openai")
	}
...
func CreateProviderFromConfig(cfg *config.ModelConfig) (LLMProvider, string, error) {
	...
	if userAgent == "" {
		userAgent = fmt.Sprintf("SylastraClaws/%s", config.Version)
	}
