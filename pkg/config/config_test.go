...
// SYLASTRACLAWS_SSH_KEY_PATH to its path for the duration of the test. This is required
...
func mustSetupSSHKey(t *testing.T) {
	...
	t.Setenv("SYLASTRACLAWS_SSH_KEY_PATH", keyPath)
}
...
func TestLoadConfig_WarnsForPlaintextAPIKey(t *testing.T) {
	...
	t.Setenv("SYLASTRACLAWS_KEY_PASSPHRASE", "test-passphrase")
...
// unchanged when SYLASTRACLAWS_KEY_PASSPHRASE is not set.
...
// TestLoadConfig_MixedKeys_NoPassphrase verifies that when SYLASTRACLAWS_KEY_PASSPHRASE
