...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/sylastraclaws_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("SYLASTRACLAWS_LOG_FILE", tmpFile)
	defer os.Unsetenv("SYLASTRACLAWS_LOG_FILE")
	...
	os.Setenv("SYLASTRACLAWS_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
...
func TestConfigureFromEnvNoEnv(t *testing.T) {
	os.Unsetenv("SYLASTRACLAWS_LOG_FILE")
	ConfigureFromEnv()
}
